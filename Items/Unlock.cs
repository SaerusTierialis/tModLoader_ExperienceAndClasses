...
namespace ExperienceAndClasses.Items {
    ...
    public class Unlock_Tier2 : Unlock {
        ...
        public override void AddRecipes() {
            Utilities.Commons.QuckRecipe(mod, new int[,] { { ItemID.Gel, 50 } , { ItemID.FallenStar, 1 } , { ModContent.ItemType<Orb_Monster>(), 1 } }, this, 1);
        }
    }
    ...
    public class Unlock_Tier3 : Unlock {
        ...
        public override void AddRecipes() {
            ...
            Utilities.Commons.QuckRecipe(mod, new int[,] { { ModContent.ItemType<Orb_Monster>(), 50 } , { ModContent.ItemType<Orb_Boss>(), 5 } }, this, 1, recipe);
        }
    }
    ...
    public class Unlock_Subclass : Unlock {
        ...
        public override void AddRecipes() {
            ...
            Utilities.Commons.QuckRecipe(mod, new int[,] { { ItemID.SoulofLight, 100 }, { ItemID.SoulofNight, 100 } , { ModContent.ItemType<Orb_Boss>(), 20 } }, this, 1, recipe);
        }
    }
