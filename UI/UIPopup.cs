...
namespace ExperienceAndClasses.UI {
    ...
    public class UIPopup : UIStateCombo {
        ...
        public void ShowTextClass(UIElement source, Systems.PlayerClass c) {
            ...
            string text = "";
            if (!Shortcuts.LOCAL_PLAYER.CSheet.Classes.Unlocked[c.ID_num]) {
                title += " [locked]";
        ...
        public void ShowResetAttributes(UIElement source) {
            ...
            string str = "Resetting attributes is free when less than " + (Systems.Attribute.RESET_POINTS_FREE + 1) +
                ...
                "Allocated: " + Shortcuts.LOCAL_PLAYER.CSheet.Attributes.Points_Spent + "\n" +
