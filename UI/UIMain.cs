...
namespace ExperienceAndClasses.UI {
    ...
    public class UIMain : UIStateCombo {
        ...
        protected override void InitializeState() {
            ...
            ability_primary = new AbilityIcon[Shortcuts.NUMBER_ABILITY_SLOTS_PER_CLASS * 2];
            ...
            ability_secondary = new AbilityIcon[Shortcuts.NUMBER_ABILITY_SLOTS_PER_CLASS * 2];
            ...
            panel.Auto = Shortcuts.LOCAL_PLAYER.loaded_ui_main.AUTO;
            panel.SetPosition(Shortcuts.LOCAL_PLAYER.loaded_ui_main.LEFT, Shortcuts.LOCAL_PLAYER.loaded_ui_main.TOP, true);
        }
        ...
        public void UpdateClassInfo() {
            ...
            for (byte i = 0; i < Shortcuts.NUMBER_ABILITY_SLOTS_PER_CLASS; i++) {
        ...
        private void UpdateAttributePoints() {
            attribute_point_text.SetText("Points: " + String.Format("{0,5}", Shortcuts.LOCAL_PLAYER.Allocation_Points_Unallocated));
        }
            ...
            if (old_xp_button.visible) {
                if (Systems.XP.Adjusting.LocalCanGainXP) {
                    ...
                    if (Systems.XP.Adjusting.LocalCanGainXPPrimary) {
                        current_class_xp = Shortcuts.LOCAL_PLAYER.Class_XP[Shortcuts.LOCAL_PLAYER.Class_Primary.ID_num];
                        xp_needed_total = Systems.XP.Requirements.GetXPReq(Shortcuts.LOCAL_PLAYER.Class_Primary, Shortcuts.LOCAL_PLAYER.Class_Levels[Shortcuts.LOCAL_PLAYER.Class_Primary.ID_num]);
                        ...
                        current_class_xp = Shortcuts.LOCAL_PLAYER.Class_XP[Shortcuts.LOCAL_PLAYER.Class_Secondary.ID_num];
                        xp_needed_total = Systems.XP.Requirements.GetXPReq(Shortcuts.LOCAL_PLAYER.Class_Secondary, Shortcuts.LOCAL_PLAYER.Class_Levels[Shortcuts.LOCAL_PLAYER.Class_Secondary.ID_num]);
                        xp_needed_remaining = xp_needed_total - current_class_xp;
                    }
