...
namespace ExperienceAndClasses.UI {
    class UIHelpSettings : UIStateCombo {
        ...
        protected override void InitializeState() {
            ...
            AddHelpTextPanel("Interface", "Right click and drag to move any interface windows. Some windows have command buttons in the top right corner while the cursor is hovering over the window. There is a hotkey that can be set to open/close the main interace.", ref sorted_items);
            AddHelpTextPanel("Damage Bonus Terms", "Increase/Decrease are additive multipliers identical to the bonuses found on equipment. For example, if you have +10% and +40% then your final damage will be 50% higher (150% total).\n\n" +
                "More/Less are true multipliers. These multiply the final damage and are applied separately. For example, if you have 50% increased damage and 30% more damage then you will deal 195% damage (150% * 1.3). Another example, if you have 30% more damage and 30% less damage then you will deal 91% damage (100% * 1.3 * 0.7).\n\n" + 
