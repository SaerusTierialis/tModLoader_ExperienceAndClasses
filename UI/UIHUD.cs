...
namespace ExperienceAndClasses.UI {
    ...
    public class UIHUD : UIStateCombo {
        ...
        protected override void InitializeState() {
            ...
            //cooldown icons
            ability_icons = new AbilityIconCooldown[Shortcuts.NUMBER_ABILITY_SLOTS_PER_CLASS * 4];
            ...
            state.Append(panel);
            panel.Auto = Shortcuts.LOCAL_PLAYER.loaded_ui_hud.AUTO;
            panel.SetPosition(Shortcuts.LOCAL_PLAYER.loaded_ui_hud.LEFT, Shortcuts.LOCAL_PLAYER.loaded_ui_hud.TOP, true);
        }
        ...
        public void UpdateClassInfo() {
            EACPlayer local = Shortcuts.LOCAL_PLAYER;
            ...
            if (!any_classes) {
                ...
                if (EACPlayer.Resources.Count == 0) {
                    ...
                    resource_bars.Clear();
                    ResourceBar rb;
                    foreach (Systems.Resource resource in EACPlayer.Resources.Values) {
                ...
                for (int i = 0; i < Shortcuts.NUMBER_ABILITY_SLOTS_PER_CLASS; i++) {
