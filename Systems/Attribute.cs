...
namespace ExperienceAndClasses.Systems {
    public abstract class Attribute {
        ...
        public static readonly float[] ALLOCATION_POINTS_PER_LEVEL_TIERS = new float[] { 0f, 1f, 2f, 3f };
        ...
        public static int LocalAllocationPointSpent() {
            ...
            for (byte i = 0; i < Shortcuts.LOCAL_PLAYER.CSheet.Attributes.Count; i++) {
                if (LOOKUP[i].Active) {
                    sum += AllocationPointCostTotal(Shortcuts.LOCAL_PLAYER.CSheet.Attributes.Allocated[i]);
                }
            }
        ...
        public class Vitality : Attribute {
            ...
            protected override void Effect(EACPlayer eacplayer, int points) {
                ...
                if (eacplayer.CSheet.Character.Is_Local) Bonus += "\n+" + bonus + " maximum life (" + PER_POINT_LIFE + " per point)";
        ...
        public class Spirit : Attribute {
            ...
            protected override void Effect(EACPlayer eacplayer, int points) {
                ...
                eacplayer.CSheet.Stats.Healing += bonus_float;
    ...
    public abstract class PowerScaling {
        ...
        public static string ApplyPower(EACPlayer eacplayer, int points) {
            ...
            if (non_minion_per > 0f) {
                ...
                eacplayer.CSheet.Stats.Damage_NonMinionAll += bonus_total;
                if (eacplayer.CSheet.Character.Is_Local) {
            ...
            if (close_range_damage_per > 0f) {
                ...
                bonus_total = bonus_per_point * points;
                eacplayer.CSheet.Stats.Damage_Close += bonus_total;
                if (eacplayer.CSheet.Character.Is_Local) {
            ...
            if (non_minion_projectile_damage_per > 0f) {
                ...
                bonus_total = bonus_per_point * points;
                eacplayer.CSheet.Stats.Damage_NonMinionProjectile += bonus_total;
                if (eacplayer.CSheet.Character.Is_Local) {
            ...
            if (holy_damage_per > 0f) {
                ...
                bonus_total = bonus_per_point * points;
                eacplayer.CSheet.Stats.Damage_Holy += bonus_total;
                if (eacplayer.CSheet.Character.Is_Local) {
